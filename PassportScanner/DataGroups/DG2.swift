...
class DG2 : DataGroup {
    private(set) var nrImages : Int = 0
    private(set) var versionNumber : Int = 0
    private(set) var lengthOfRecord : Int = 0
    private(set) var numberOfFacialImages : Int = 0
    private(set) var facialRecordDataLength : Int = 0
    private(set) var nrFeaturePoints : Int = 0
    private(set) var gender : Int = 0
    private(set) var eyeColor : Int = 0
    private(set) var hairColor : Int = 0
    private(set) var featureMask : Int = 0
    private(set) var expression : Int = 0
    private(set) var poseAngle : Int = 0
    private(set) var poseAngleUncertainty : Int = 0
    private(set) var faceImageType : Int = 0
    private(set) var imageDataType : Int = 0
    private(set) var imageWidth : Int = 0
    private(set) var imageHeight : Int = 0
    private(set) var imageColorSpace : Int = 0
    private(set) var sourceType : Int = 0
    private(set) var deviceType : Int = 0
    private(set) var quality : Int = 0
